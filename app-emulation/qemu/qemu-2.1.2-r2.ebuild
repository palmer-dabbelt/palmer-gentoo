...
# $Header: /var/cvsroot/gentoo-x86/app-emulation/qemu/qemu-2.1.2-r2.ebuild,v 1.3 2014/12/21 11:41:06 ago Exp $
...
mips64 mips64el mipsel or32 ppc ppc64 s390x sh4 sh4eb riscv sparc sparc64 unicore32
x86_64"
...
src_prepare() {
	...
	epatch "${FILESDIR}"/${PN}-2.1.2-vnc-sanitize-bits.patch #527088
        epatch "${FILESDIR}"/${PN}-2.1.2-riscv.patch
	[[ -n ${BACKPORTS} ]] && \
